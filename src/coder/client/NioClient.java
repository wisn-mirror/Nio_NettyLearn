        ...
        while (true) {
            ...
            while (ite.hasNext()) {
                ...
                if (key.isConnectable()) {
                    ...
                    // 设置成非阻塞
                    channel.configureBlocking(false);
                    Request request=Request.valueOf((short)1,(short)2,("helloworld").getBytes());
                    //在这里可以给服务端发送信息哦
                    channel.write(ByteBuffer.wrap(getBytes(request).array()));
    ...
    public void read(SelectionKey key) throws IOException{
        ...
        while(true){
            ...
            if(read!=-1){
                ...
                System.out.println("nioClient:"+msg);
...
//            channel.write(ByteBuffer.wrap((msg+new Date()).getBytes()));
    ...
    public  ByteBuffer getBytes(Request  request){
        ...
        System.out.println("  WWWW:"+Arrays.toString(byteBuf.array()));
        return byteBuf;
    }
